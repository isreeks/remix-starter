            ...
            <div className="w-[350px]" >
                ...
                <Form  {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2 mt-4">
                        ...
                        />
                        <Button className="text-lg font-semibold w-full " size={"lg"} type="submit" >Register</Button>
                    </form>
                </Form>

                <Button variant={"outline"} className="  w-full mt-4" onClick={() => navigate("/signup")}> Already have an account</Button>
